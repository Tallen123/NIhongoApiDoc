    ...
    <div className="App">
      <div className="Name">
        ...
        <div className="PannelDiv">
          <Pannel text="This API is still is development and is subject to change."/>
          <Pannel text='The API consists of Hiragana, Katakana, Kanji, Vocabulary, Numbers and Grammar.'text2ndLine='The endpoints are below, Kanji it self is the more complicated one as this contains JLPT N1-N5 aswell as GRADES 1-6'/>
